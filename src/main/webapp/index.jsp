...
<body>
	...
	<div class="container mt-5">
		...
		<div class="d-flex justify-content-center gap-3 mt-4">
			<a href="/BankingManagementSystem/registerPage.jsp"
				class="btn btn-success btn-lg">Register</a> <a
				href="/BankingManagementSystem/loginPage.jsp" class="btn btn-primary btn-lg">Login</a>
			<a href="/BankingManagementSystem/exit.jsp" class="btn btn-danger btn-lg">Exit</a>
		</div>
	</div>
	...
	%>
	<script src="/BankingManagementSystem/script.js"></script>
</body>
</html>
