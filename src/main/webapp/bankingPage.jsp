...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
		<div class="container-fluid">
			<a class="navbar-brand" href="/BankingManagementSystem/index.jsp">Banking
				System</a>
		...
		<div class="row justify-content-center">
			<div class="col-md-10 mt-5">
				<div class="d-flex justify-content-center gap-5">
					<a
						href="/BankingManagementSystem/verifySecurityPin.jsp?operation=checkBalance"
						class="btn btn-info btn-lg text-white">Check Balance</a> <a
						href="/BankingManagementSystem/verifySecurityPin.jsp?operation=viewAccount"
						class="btn btn-secondary btn-lg">View Account Details</a> <a
						href="/BankingManagementSystem/verifySecurityPin.jsp?operation=debitMoney"
						class="btn btn-danger btn-lg">Debit Money</a> <a
						href="/BankingManagementSystem/verifySecurityPin.jsp?operation=creditMoney"
						class="btn btn-success btn-lg">Credit Money</a> <a
						href="/BankingManagementSystem/verifySecurityPin.jsp?operation=transferMoney"
	...
	<div
		...
		<a href="/BankingManagementSystem/verifySecurityPin.jsp?operation=unLockAccount"
			class="btn btn-info text-white">Click to unlock your
			account</a>
		<a href="/BankingManagementSystem/homePage.jsp"
