			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item"><a class="nav-link"
						href="/BankingManagementSystem/profilePage.jsp">Profile</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/BankingManagementSystem/logoutPage.jsp">Logout</a></li>
				</ul>
			</div>
		</div>
	</nav>
				...
				<form action="updateUserDetails" method="post"
					...
					<div class="d-flex gap-3">
						<button type="submit" class="btn btn-primary w-50">Save
							Changes</button>
						<a href="/BankingManagementSystem/profilePage.jsp" class="btn btn-danger w-50">Cancel
						</a>
					</div>
				</form>
			</div>
