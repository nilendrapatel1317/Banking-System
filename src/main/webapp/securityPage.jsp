		...
		<div class="row justify-content-center">
			<div class="col-md-12 mt-5">
				<div class="d-flex justify-content-center gap-4 flex-wrap">
					<a href="/BankingManagementSystem/changePasswordPage.jsp"
						class="btn btn-warning btn-lg text-white">Change Login
						Password</a> <a href="/BankingManagementSystem/changePinPage.jsp"
						class="btn btn-success btn-lg">Change Security Pin</a><a
						href="/BankingManagementSystem/verifyProfilePassword.jsp"
					...
					%>
					<a
						href="/BankingManagementSystem/verifySecurityPin.jsp?operation=unLockAccount"
					...
					%>
					<a
						href="/BankingManagementSystem/verifySecurityPin.jsp?operation=lockAccount"
